...
type PolicyRule struct {
	...
	AppRouteID *uuid.UUID `gorm:"type:uuid;index" json:"appRouteId"` // nullable FK — null means global/ZTA-only
	AppRoute   *AppRoute  `gorm:"foreignKey:AppRouteID" json:"appRoute,omitempty"`
